...
#define WIFI_DEFAULT_CONNECT_TIMEOUT_S 30 
...
static wifi_config_callback_t wifi_config_callback = NULL;
static void(*wifi_status_callback)(int status) = NULL;
//---------------------------------------//
...
static void event_handler(void* arg, esp_event_base_t event_base,int32_t event_id, void* event_data)
{
    ...
    {
        wifi_connected = true;
        wifi_status_callback(WIFI_STATUS_GOT_IP);
